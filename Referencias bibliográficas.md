...
[16] 	D. Fernández Cambronero, «Tendencias en Redes de Campus - I Jornadas sobre Tecnologías de la Información y las Comunicaciones en la UPM,» noviembre 2015. [En línea]. Disponible en: http://www.upm.es/sfs/E.T.S.I.%20Navales/AAJornadas/presentaciones/Tendencias-redes-campus-DFC-v1.pdf. [Último acceso: abril 2022].
...
[31] 	Open Networking Foundation, «Open Network Operating System (ONOS) SDN Controller for SDN/NFV Solutions,» [En línea]. Disponible en: https://opennetworking.org/onos/. [Último acceso: abril 2022].
...
[47] 	J. M. Halpern, R. Haas, A. Doria, L. Dong, W. Wang, H. M. Khosravi, J. H. Salim y R. Gopal, «RFC 5810 - Forwarding and Control Element Separation (ForCES) Protocol Specification - IETF,» marzo 2010. [En línea]. Disponible en: https://datatracker.ietf.org/doc/rfc5810/. [Último acceso: abril 2022].
...
[63] 	The Apache Software Foundation, «Apache Karaf - The Modulith Runtime,» [En línea]. Disponible en: https://karaf.apache.org/. [Último acceso: abril 2022].
...
[78] 	W. Stallings, F. Agboma y S. Jelassi, Foundations of modern networking: SDN, NFV, QoE, IoT, and Cloud, Indianapolis: Pearson, 2016.
...
[94] 	European Telecommunications Standards Institute (ETSI), «Open Source MANO (OSM),» [En línea]. Disponible en: https://osm.etsi.org/. [Último acceso: mayo 2022].
...
[109] 	Tutorials Point, «HTTP Tutorial,» [En línea]. Disponible en: https://www.tutorialspoint.com/http/. [Último acceso: mayo 2022].
...
[128] 	Cloudflare, Inc, «¿Qué es un proxy inverso? Servidores proxy explicados,» [En línea]. Disponible en: https://www.cloudflare.com/es-es/learning/cdn/glossary/reverse-proxy/. [Último acceso: mayo 2022].
...
[146] 	DASH Industry Forum, «GitHub - DASH.js,» [En línea]. Disponible en: https://github.com/Dash-Industry-Forum/dash.js. [Último acceso: mayo 2022].
...
[165] 	Canonical Limited, «Ubuntu - Enterprise Open Source and Linux,» [En línea]. Disponible en: https://ubuntu.com/. [Último acceso: mayo 2022].
...
[180] 	Departamento de Ingeniería de Sistemas Telemáticos (DIT) - Universidad Politécnica de Madrid (UPM), «VNX Filesystems Repository,» [En línea]. Disponible en: http://vnx.dit.upm.es/vnx/filesystems/. [Último acceso: mayo 2022].
...
[198] 	LuaJIT Project, «LuaJIT Download,» [En línea]. Disponible en: https://luajit.org/download.html. [Último acceso: mayo 2022].
...
[216] 	J. Van Schooneveld, «Real Python - Python and REST APIs: Interacting With Web Services,» julio 2021. [En línea]. Disponible en: https://realpython.com/api-integration-in-python/. [Último acceso: mayo 2022].
...
[232] 	Open Networking Foundation (ONF), «TrafficTreatment - ONOS Java API (Version 2.3.0),» [En línea]. Disponible en: http://api.onosproject.org/2.3.0/apidocs/org/onosproject/net/flow/TrafficTreatment.html. [Último acceso: mayo 2022].
...
[247] 	Internet Assigned Numbers Authority (IANA), «IEEE 802 Numbers (EtherType),» febrero 2022. [En línea]. Disponible en: https://www.iana.org/assignments/ieee-802-numbers/ieee-802-numbers.xhtml. [Último acceso: mayo 2022].
...
[263] 	Lua Users, «String Trim - Lua Wiki,» [En línea]. Disponible en: http://lua-users.org/wiki/StringTrim. [Último acceso: mayo 2022].
...
[279] 	Linux Foundation, «connect(2) - Initiate a connection on a socket - Linux Manual Pages (man7.org),» marzo 2021. [En línea]. Disponible en: https://man7.org/linux/man-pages/man2/connect.2.html. [Último acceso: junio 2022].

[280] 	World Wide Web Consortium (W3C), «CSS Specifications,» abril 2022. [En línea]. Disponible en: https://www.w3.org/Style/CSS/specs.en.html. [Último acceso: mayo 2022].

[281] 	Die.net, «ping(8) - Linux Manual Page,» [En línea]. Disponible en: https://linux.die.net/man/8/ping. [Último acceso: junio 2022].

[282] 	R. Moskowitz, D. Karrenberg, Y. Rekhter, E. Lear y G. J. de Groot, «RFC 1918 - Address Allocation for Private Internets - IETF,» febrero 1996. [En línea]. Disponible en: https://datatracker.ietf.org/doc/rfc1918/. [Último acceso: junio 2022].

[283] 	Réseaux IP Européens Network Coordination Centre (RIPE NCC), «The RIPE NCC has run out of IPv4 Addresses,» 25 noviembre 2019. [En línea]. Disponible en: https://www.ripe.net/publications/news/about-ripe-ncc-and-ripe/the-ripe-ncc-has-run-out-of-ipv4-addresses. [Último acceso: junio 2022].

[284] 	D. S. E. Deering y B. Hinden, «RFC 4291 - IP Version 6 Addressing Architecture - IETF,» febrero 2006. [En línea]. Disponible en: https://datatracker.ietf.org/doc/rfc4291/. [Último acceso: junio 2022].

[285] 	E. Klein, G. Van de Velde, R. Droms, T. L. Hain y B. E. Carpenter, «RFC 4864 - Local Network Protection for IPv6 - IETF,» mayo 2007. [En línea]. Disponible en: https://datatracker.ietf.org/doc/rfc4864/. [Último acceso: junio 2022].

[286] 	S. Hogg, «You Thought There Was No NAT for IPv6, But NAT Still Exists - Infoblox,» 28 diciembre 2021. [En línea]. Disponible en: https://blogs.infoblox.com/ipv6-coe/you-thought-there-was-no-nat-for-ipv6-but-nat-still-exists/. [Último acceso: junio 2022].

[287] 	Internet Assigned Numbers Authority (IANA), «Service Name and Transport Protocol Port Number Registry,» [En línea]. Disponible en: https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml. [Último acceso: junio 2022].

[288] 	OpenInfra Foundation, «Open Source Cloud Computing Infraestructure - OpenStack,» [En línea]. Disponible en: https://www.openstack.org/. [Último acceso: junio 2022].

[289] 	Parlamento Europeo, «Economía circular: definición, importancia y beneficios,» abril 2022. [En línea]. Disponible en: https://www.europarl.europa.eu/news/es/headlines/economy/20151201STO05603/economia-circular-definicion-importancia-y-beneficios. [Último acceso: junio 2022].

[290] 	Colegio Oficial de Ingenieros de Telecomunicación (COIT), «Reglamento General de Régimen Interior - Capítulo IX - Código Deontológico,» 2022. [En línea]. Disponible en: https://www.coit.es/sites/default/files/codigo_deontologico_coit-_2022.pdf. [Último acceso: junio 2022].

[291] 	Diario Oficial de la Unión Europea, «Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo - Reglamento General de Protección de Datos (RGPD),» 27 abril 2016. [En línea]. Disponible en: https://eur-lex.europa.eu/legal-content/ES/TXT/PDF/?uri=CELEX:32016R0679&from=ES. [Último acceso: junio 2022].

[292] 	Boletín Oficial del Estado (BOE) - Gobierno de España, «Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales - BOE-A-2018-16673,» 6 diciembre 2018. [En línea]. Disponible en: https://www.boe.es/buscar/pdf/2018/BOE-A-2018-16673-consolidado.pdf. [Último acceso: junio 2022].

[293] 	Instituto Nacional de Estadística (INE), «Instituto Nacional de Estadística (INE) - Página principal,» [En línea]. Disponible en: https://www.ine.es/. [Último acceso: junio 2022].

[294] 	Instituto Nacional de Estadística (INE), «Banco de series temporales - Serie ETCL1173: Coste laboral total por hora (Nacional), en Euros - Telecomunicaciones,» [En línea]. Disponible en: https://www.ine.es/consul/serie.do?d=true&s=ETCL1173. [Último acceso: junio 2022].
